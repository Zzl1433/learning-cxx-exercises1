            ...
            for(unsigned int i1 = 0; i1 < shape[1]; ++i1){
                for(unsigned int i2 = 0; i2 < shape[2]; ++i2){
                    for(unsigned int i3 = 0; i3 < shape[3]; ++i3){
                        // this_index   [i0, i1, i2, i3]
                        // others_index [j0, j1, j2, j3]
                        ...
                        unsigned int this_index = ((shape[1] * i0 + i1) * shape[2] + i2) * shape[3] + i3;
                        unsigned int others_index = ((others.shape[1] * j0 + j1) * others.shape[2] + j2) * others.shape[3] + j3;
